...
CITIES = [
    ...
    ('Washington','DC'),
    # ── Round 4 expansion: ~210 more cities ──────────────────────────
    # Mid-tier metros, suburbs, real-estate-active vacation areas.
    # Added 2026-06-10. Skips duplicates with the original set above.
    ('Tuscaloosa','AL'), ('Auburn','AL'), ('Decatur','AL'), ('Madison','AL'), ('Dothan','AL'), ('Hoover','AL'),
    ('Wasilla','AK'), ('Sitka','AK'),
    ('Flagstaff','AZ'), ('Yuma','AZ'), ('Prescott','AZ'), ('Sedona','AZ'), ('Lake Havasu City','AZ'),
    ('Jonesboro','AR'), ('Hot Springs','AR'), ('Bentonville','AR'),
    ('Pasadena','CA'), ('Berkeley','CA'), ('Burbank','CA'), ('Costa Mesa','CA'), ('Daly City','CA'), ('Carlsbad','CA'), ('Sunnyvale','CA'), ('Santa Rosa','CA'), ('Hayward','CA'), ('Salinas','CA'), ('Palm Springs','CA'), ('Palmdale','CA'), ('Lancaster','CA'), ('Pomona','CA'), ('Escondido','CA'), ('Torrance','CA'), ('Orange','CA'), ('Vallejo','CA'), ('Concord','CA'), ('Roseville','CA'), ('Elk Grove','CA'), ('Visalia','CA'),
    ('Greeley','CO'), ('Loveland','CO'), ('Castle Rock','CO'), ('Aspen','CO'), ('Vail','CO'), ('Telluride','CO'),
    ('Norwalk','CT'), ('Greenwich','CT'),
    ('Newark','DE'),
    ('Naples','FL'), ('Sarasota','FL'), ('Bradenton','FL'), ('West Palm Beach','FL'), ('Boca Raton','FL'), ('Delray Beach','FL'), ('Pompano Beach','FL'), ('Coral Springs','FL'), ('Pensacola','FL'), ('Daytona Beach','FL'), ('Palm Beach','FL'), ('Key West','FL'), ('Marco Island','FL'), ('Vero Beach','FL'), ('Ocala','FL'), ('Lakeland','FL'), ('Kissimmee','FL'), ('Doral','FL'), ('Aventura','FL'), ('Miami Beach','FL'), ('Coral Gables','FL'), ('Hialeah Gardens','FL'),
    ('Alpharetta','GA'), ('Marietta','GA'), ('Roswell','GA'), ('Sandy Springs','GA'), ('Johns Creek','GA'),
    ('Kailua','HI'), ('Kaneohe','HI'), ('Wailea','HI'),
    ('Coeur d Alene','ID'), ('Sun Valley','ID'),
    ('Schaumburg','IL'), ('Evanston','IL'), ('Oak Park','IL'), ('Champaign','IL'),
    ('Indianapolis Downtown','IN'),
    ('Iowa City','IA'), ('Sioux City','IA'),
    ('Lawrence','KS'), ('Olathe','KS'),
    ('Owensboro','KY'), ('Frankfort','KY'),
    ('Metairie','LA'), ('Lake Charles','LA'),
    ('Lewiston','ME'),
    ('Annapolis','MD'), ('Bethesda','MD'), ('Silver Spring','MD'), ('Columbia','MD'), ('Towson','MD'), ('Bowie','MD'),
    ('Newton','MA'), ('Quincy','MA'), ('Brookline','MA'), ('Somerville','MA'),
    ('Royal Oak','MI'), ('Birmingham','MI'), ('Bloomfield Hills','MI'), ('Traverse City','MI'),
    ('Bloomington','MN'), ('Edina','MN'), ('Eden Prairie','MN'),
    ('Biloxi','MS'),
    ('Independence','MO'), ('Lee Summit','MO'), ('OFallon','MO'),
    ('Helena','MT'), ('Whitefish','MT'),
    ('Bellevue','NE'),
    ('Carson City','NV'), ('Pahrump','NV'),
    ('Concord','NH'),
    ('Hoboken','NJ'), ('Princeton','NJ'), ('Cherry Hill','NJ'), ('Camden','NJ'),
    ('Roswell','NM'), ('Taos','NM'),
    ('Brooklyn','NY'), ('Queens','NY'), ('Bronx','NY'), ('Staten Island','NY'), ('White Plains','NY'), ('Long Beach','NY'), ('East Hampton','NY'), ('Southampton','NY'), ('Mount Vernon','NY'),
    ('Asheville','NC'), ('Wilmington','NC'), ('Cary','NC'), ('High Point','NC'), ('Chapel Hill','NC'), ('Concord','NC'),
    ('Minot','ND'),
    ('Lakewood','OH'), ('Parma','OH'), ('Canton','OH'), ('Youngstown','OH'),
    ('Edmond','OK'),
    ('Bend','OR'), ('Beaverton','OR'), ('Medford','OR'), ('Hillsboro','OR'),
    ('Bethlehem','PA'), ('Lancaster','PA'), ('Harrisburg','PA'), ('Scranton','PA'),
    ('Newport','RI'),
    ('Mount Pleasant','SC'), ('Myrtle Beach','SC'), ('Hilton Head Island','SC'),
    ('Pierre','SD'),
    ('Franklin','TN'), ('Murfreesboro','TN'),
    ('Plano','TX'), ('McAllen','TX'), ('Round Rock','TX'), ('Tyler','TX'), ('Waco','TX'), ('Galveston','TX'), ('League City','TX'), ('The Woodlands','TX'), ('Sugar Land','TX'), ('Pearland','TX'), ('Killeen','TX'), ('Beaumont','TX'), ('Abilene','TX'), ('Wichita Falls','TX'), ('Midland','TX'), ('Odessa','TX'), ('Laredo','TX'),
    ('Park City','UT'), ('Sandy','UT'), ('St George','UT'),
    ('Stowe','VT'),
    ('Charlottesville','VA'), ('Roanoke','VA'), ('Chesapeake','VA'), ('Lynchburg','VA'),
    ('Bellingham','WA'), ('Olympia','WA'), ('Redmond','WA'), ('Kirkland','WA'), ('Renton','WA'), ('Federal Way','WA'),
    ('Morgantown','WV'),
    ('Appleton','WI'), ('Eau Claire','WI'), ('Kenosha','WI'),
    ('Jackson','WY'), ('Sheridan','WY'),
]
